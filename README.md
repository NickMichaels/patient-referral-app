...
* As an admin, I want to be able to create, update and delete patient (very limited scope - just a `name` column and `data` column - which would hold their "patient record" and could later be encoded in some sort of HL7 format and encrypted) records :white_check_mark:
